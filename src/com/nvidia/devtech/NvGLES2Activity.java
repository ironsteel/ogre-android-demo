...
/**
 * This helper class takes {@link NvGLESActivity} one step further by enabling GLES2 rendering.
 */
public abstract class NvGLES2Activity extends NvGLESActivity {
	...
	protected boolean initEGL() {
		...
		contextAttrs = new int[] { EGL_CONTEXT_CLIENT_VERSION, 2, EGL10.EGL_NONE };
